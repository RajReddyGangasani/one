...
<head>
    ...
    <title>DevOps trainer Engineer and verygood Trainer Portfolio</title>
    <style>
        /* General Styles */
        body {
...
<body>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm Mustafa,very good Trainer come DevOps Engineer passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
